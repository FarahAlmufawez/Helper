...
<body>
  ...
  <form action="response.php" method="post"class="w3-container w3-display-middle w3-card-4 w3-center w3-white w3-text-brown w3-margin" style="width:900px;height:450px">
<h2 class="w3-container w3-center w3-text-brown">Ask Question</h2>
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-pencil"></i></div>
    <div class="w3-rest ">

      <textarea class="w3-input w3-border w3-padding-30 w3-left-align"name="message" rows="6" cols="25"   placeholder="Write Your Question..."></textarea>
    </div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-book"></i></div>
    ...
    <option value="Discrete Algorithmic
Mathematics">Discrete Algorithmic
Mathematics </option>
    <option value="Matrix Analysis">Matrix Analysis</option>
    <option value="Discrete Algorithmic
Mathematics">Discrete Algorithmic
Mathematics</option>
    <option value="Basic Abstract Algebra">Basic Abstract Algebra</option>
    <option value="Logarithms a Unique
and Simplified Step">Logarithms a Unique
and Simplified Step</option>
...
<p class="w3-center">
<button class="w3-button w3-section w3-win8-olive w3-ripple"> Confirm </button>
